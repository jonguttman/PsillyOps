...
interface AssignProductionRunModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function AssignProductionRunModal({
  isOpen,
  onClose,
  onAssign,
  productionRunId,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">
                {isReassignment ? "Reassign" : "Assign"} Production Run
              </h3>
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={isReassignment ? "Why are you reassigning this run?" : "Optional note about this assignment"}
              rows={3}
