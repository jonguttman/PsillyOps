...
const tabs: NavTab[] = [
  ...
  { id: 'more', label: 'More', href: '#', icon: MoreHorizontal, isSheet: true },
];
 ...
 * - "More" opens a sheet with additional navigation
 */
export function MobileBottomNav({ userRole = 'USER' }: MobileBottomNavProps) {
  ...
  const isActive = (tab: NavTab) => {
    ...
    // More is active when sheet is open or on settings-related pages
    if (tab.id === 'more') {
      return isMoreSheetOpen || 
        pathname.startsWith('/ops/settings') ||
        pathname.startsWith('/ops/qr/') ||
        pathname.startsWith('/ops/transparency') ||
        pathname.startsWith('/ops/security') ||
        pathname.startsWith('/ops/users') ||
        pathname.startsWith('/ops/activity') ||
        pathname.startsWith('/ops/strains') ||
        pathname.startsWith('/ops/vendors') ||
        pathname.startsWith('/ops/help');
    }
